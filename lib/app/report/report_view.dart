...
import 'package:flutter_todo_app_getx/app/core/value/colors.dart';
...
class ReportPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      var percent = (completedTask / createdTasks * 100).toStringAsFixed(0);
      return ListView(
        children: [
          Padding(
